        ...
        public IEnumerable<Singer> Singers {
            get => new List<Singer>(){
                new Singer()
                {
                    ...
                    Photo=new Uri("https://upload.wikimedia.org/wikipedia/commons/thumb/7/7f/LOBODA_%284%29_%D0%BD%D0%B0_Big_Love_Show_2018_%D0%B2_%D0%A1%D0%9F%D0%B1.jpg/267px-LOBODA_%284%29_%D0%BD%D0%B0_Big_Love_Show_2018_%D0%B2_%D0%A1%D0%9F%D0%B1.jpg")
                },
                new Singer()
                {
                    SingerId="2",
                    ...
                    Photo=new Uri("https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Eminem_-_Concert_for_Valor_in_Washington%2C_D.C._Nov._11%2C_2014_%282%29_%28Cropped%29.jpg/267px-Eminem_-_Concert_for_Valor_in_Washington%2C_D.C._Nov._11%2C_2014_%282%29_%28Cropped%29.jpg")
                },
                new Singer()
                {
                    SingerId="3",
                    ...
                    Photo=new Uri("https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Lady_Gaga_Toronto_Film_Festival_2017_%28cropped2%29.jpg/300px-Lady_Gaga_Toronto_Film_Festival_2017_%28cropped2%29.jpg")
                }
            };
        }
    }
